...
SECRET_KEY = 'django-insecure-2o-+i6nxfxry=cy%b*bkvjqkqw%r6zanynwv@-6l0(l=!aj@74'
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY":'django-insecure-2o-+i6nxfxry=cy%b*bkvjqkqw%r6zanynwv@-6l0(l=!aj@74'
...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": ""  # Removes the ":1:" prefix
    }
}
